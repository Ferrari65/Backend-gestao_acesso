...
public interface ColaboradorControllerDocs {
    ...
    ResponseEntity<List<ColaboradorDTO>> listarColaborador();

    @Operation(summary = "Buscar colaborador por ID",
            description = "Retorna dados do colaborador por `ID`",
            responses = {
                    @ApiResponse(
                            description = "Success",
                            responseCode = "200",
    ...
    ResponseEntity<ColaboradorDTO> buscarPorId(@PathVariable UUID idColaborador);
}
